...
public abstract class IterationMethod {
	...
	public class IterationBasic {
		protected final Model<Double> model;
		protected double[] soln;

		public IterationBasic(Model<Double> model)
		{
			this.model = model;
		}
	...
	{
		public SingleVectorIterationValIter(Model<Double> model)
		{
			super(model);
		}
	}
	...
	{
		public SingleVectorIterationIntervalIter(Model<Double> model)
		{
			super(model);
		}
	}
	...
	protected abstract class TwoVectorIteration extends IterationBasic implements IterationValIter, IterationIntervalIter {
		...
		/** Constructor */
		protected TwoVectorIteration(Model<Double> model, IterationMethod.IterationPostProcessor postProcessor)
		{
			super(model);
